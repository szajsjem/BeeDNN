...
namespace beednn {
///////////////////////////////////////////////////////////////////////////////
LayerEmbed::LayerEmbed(const Index vocabSize, const Index dimensionSize,
                       const Index maxPositon,
                       const std::string &sBiasInitializer)
    : Layer("Normalize"), _pPositionSize(maxPositon), _pVocabSize(vocabSize),
...
Layer *LayerEmbed::clone() const {
  LayerEmbed *pLayer = new LayerEmbed(_pVocabSize, _pDimensionSize,
                                      _pPositionSize, get_initializer());
  pLayer->_bias = _bias;
  pLayer->_bias2 = _bias2;
  return pLayer;
}
///////////////////////////////////////////////////////////////////////////////
bool LayerEmbed::init(size_t &in, size_t &out, std::vector<MatrixFloat> &internalCalculationMatrices, bool debug) {
  ...
  Initializers::compute(get_initializer(), _bias2, _pPositionSize,
                        _pDimensionSize);
...
///////////////////////////////////////////////////////////////////////////////
void LayerEmbed::backpropagation(const MatrixFloat &mIn, const MatrixFloat &mGradientOut, MatrixFloat &mGradientIn, std::vector<MatrixFloat> &internalCalculationMatrices, int start) {
  ...
  // it should be the first layer because tokenizer can process text into
  // diffrent number of tokens,
  //  i don't think you can implement it as layer
  // assert(_bFirstLayer);
}

///////////////////////////////////////////////////////////////
bool LayerEmbed::has_weights() const { return true; }
///////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////
Layer *LayerEmbed::load(std::istream &from) { return NULL; }
///////////////////////////////////////////////////////////////
Layer *LayerEmbed::construct(std::initializer_list<float> fArgs,
                             std::string sArg) {
  if (fArgs.size() != 3)
    return nullptr; // vocabSize, dimensionSize, maxPosition
  auto args = fArgs.begin();
  return new LayerEmbed(*args, *(args + 1), *(args + 2), sArg);
}
///////////////////////////////////////////////////////////////
std::string LayerEmbed::constructUsage() {
  return "embedding layer with positional "
