...
//
///////////////////////////////////////////////////////////////////////////////
LayerCRelu::LayerCRelu() : Layer("CRelu") {}
///////////////////////////////////////////////////////////////////////////////
LayerCRelu::~LayerCRelu() {}
///////////////////////////////////////////////////////////////////////////////
Layer *LayerCRelu::clone() const { return new LayerCRelu(); }
///////////////////////////////////////////////////////////////////////////////
bool LayerCRelu::init(size_t &in, size_t &out, std::vector<MatrixFloat> &internalCalculationMatrices, bool debug) {
  out = in;
...
///////////////////////////////////////////////////////////////////////////////
void LayerCRelu::backpropagation(const MatrixFloat &mIn, const MatrixFloat &mGradientOut, MatrixFloat &mGradientIn, std::vector<MatrixFloat> &internalCalculationMatrices, int start) {
  if (_bFirstLayer)
    return;

  Index iInSize = mIn.cols();
  MatrixFloat mLocalGrad;
  mLocalGrad.setZero(mIn.rows(), iInSize);
  for (Index r = 0; r < mIn.rows(); r++)
    for (Index c = 0; c < iInSize; c++) {
      if (mIn(r, c) > 0.)
        mLocalGrad(r, c) = mGradientOut(r, c);
      else
        mLocalGrad(r, c) = -mGradientOut(r, c + iInSize);
    }
...
///////////////////////////////////////////////////////////////
Layer *LayerCRelu::load(std::istream &from) { return NULL; }
///////////////////////////////////////////////////////////////
Layer *LayerCRelu::construct(std::initializer_list<float> fArgs,
                             std::string sArg) {
  if (fArgs.size() != 0)
    return nullptr;
...
///////////////////////////////////////////////////////////////
bool LayerCRelu::has_weights() const { return false; }
///////////////////////////////////////////////////////////////
