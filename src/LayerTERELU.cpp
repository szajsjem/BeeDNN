...
///////////////////////////////////////////////////////////////////////////////
LayerTERELU::LayerTERELU() : Layer("TERELU") {}
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
bool LayerTERELU::init(size_t &in, size_t &out, std::vector<MatrixFloat> &internalCalculationMatrices, bool debug) {
  _weight.resize(0, 0);
  _alpha = 1.f;
  _mu = 1.f;
  out = in;
...
///////////////////////////////////////////////////////////////////////////////
void LayerTERELU::backpropagation(const MatrixFloat &mIn, const MatrixFloat &mGradientOut, MatrixFloat &mGradientIn, std::vector<MatrixFloat> &internalCalculationMatrices, int start) {
  ...
  for (Index i = 0; i < mLocalGrad.rows(); i++)
    for (Index j = 0; j < mLocalGrad.cols(); j++) {
      if (mIn(i, j) <= 0.f)
        mLocalGrad(i, j) *= _alpha * expf(mIn(i, j));
      else if (mIn(i, j) >= _mu)
        mLocalGrad(i, j) *= _weight(j) * expf(_mu - mIn(i, j));
    }
...
///////////////////////////////////////////////////////////////
Layer *LayerTERELU::load(std::istream &from) { return NULL; }
///////////////////////////////////////////////////////////////
Layer *LayerTERELU::construct(std::initializer_list<float> fArgs,
                              std::string sArg) {
  if (fArgs.size() != 0)
    return nullptr;
...
///////////////////////////////////////////////////////////////
bool LayerTERELU::has_weights() const { return false; }
///////////////////////////////////////////////////////////////
