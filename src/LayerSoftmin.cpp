...
///////////////////////////////////////////////////////////////////////////////
LayerSoftmin::LayerSoftmin() : Layer("Softmin") {}
///////////////////////////////////////////////////////////////////////////////
LayerSoftmin::~LayerSoftmin() {}
///////////////////////////////////////////////////////////////////////////////
Layer *LayerSoftmin::clone() const { return new LayerSoftmin(); }
///////////////////////////////////////////////////////////////////////////////
...
void LayerSoftmin::backpropagation(const MatrixFloat &mIn, const MatrixFloat &mGradientOut, MatrixFloat &mGradientIn, std::vector<MatrixFloat> &internalCalculationMatrices, int start) {
  if (_bFirstLayer)
    return;
  ...
  for (Index r = 0; r < mIn.rows(); r++) // todo simplify and optimize
  {
    ...
    for (Index c = 0; c < S.cols(); c++) {
      float expx = S(c);
      mLocalGrad(r, c) = -mGradientOut(r, c) * (expx * (s - expx)) / (s * s);
    }
  }
...
///////////////////////////////////////////////////////////////
Layer *LayerSoftmin::load(std::istream &from) { return NULL; }
///////////////////////////////////////////////////////////////
Layer *LayerSoftmin::construct(std::initializer_list<float> fArgs,
                               std::string sArg) {
  if (fArgs.size() != 0)
    return nullptr;
...
///////////////////////////////////////////////////////////////
bool LayerSoftmin::has_weights() const { return false; }
///////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
bool LayerSoftmin::init(size_t &in, size_t &out, std::vector<MatrixFloat> &internalCalculationMatrices, bool debug) {
