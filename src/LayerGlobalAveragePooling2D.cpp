...
///////////////////////////////////////////////////////////////////////////////
LayerGlobalAveragePooling2D::LayerGlobalAveragePooling2D(Index iInRows,
                                                         Index iInCols,
                                                         Index iInChannels)
...
///////////////////////////////////////////////////////////////////////////////
void LayerGlobalAveragePooling2D::get_params(Index &iInRows, Index &iInCols,
...
///////////////////////////////////////////////////////////////////////////////
void LayerGlobalAveragePooling2D::forward(const MatrixFloat &mIn,
                                          MatrixFloat &mOut) {
...
///////////////////////////////////////////////////////////////////////////////
void LayerGlobalAveragePooling2D::backpropagation(const MatrixFloat &mIn, const MatrixFloat &mGradientOut, MatrixFloat &mGradientIn, std::vector<MatrixFloat> &internalCalculationMatrices, int start) {
  (void)mIn;
  ...
  mLocalGrad.resize(mGradientOut.rows(), _iInPlaneSize * _iInChannels);
...
///////////////////////////////////////////////////////////////
Layer *LayerGlobalAveragePooling2D::load(std::istream &from) { return NULL; }
///////////////////////////////////////////////////////////////
Layer *
LayerGlobalAveragePooling2D::construct(std::initializer_list<float> fArgs,
                                       std::string sArg) {
  if (fArgs.size() != 3)
...
///////////////////////////////////////////////////////////////
bool LayerGlobalAveragePooling2D::init(size_t &in, size_t &out, std::vector<MatrixFloat> &internalCalculationMatrices, bool debug) {
...
///////////////////////////////////////////////////////////////
bool LayerGlobalAveragePooling2D::has_weights() const { return false; }
///////////////////////////////////////////////////////////////
std::vector<MatrixFloat *> LayerGlobalAveragePooling2D::weights() const {
  return std::vector<MatrixFloat *>();
}
///////////////////////////////////////////////////////////////
std::vector<MatrixFloat *>
LayerGlobalAveragePooling2D::gradient_weights() const {
  return std::vector<MatrixFloat *>();
}
///////////////////////////////////////////////////////////////////////////////
} // namespace beednn