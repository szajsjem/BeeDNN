...
namespace beednn {
LayerSelfAttention::LayerSelfAttention() : LayerSelfDot("LayerSelfAttention") {}
Layer *LayerSelfAttention::clone() const { return new LayerSelfAttention(); }
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
void LayerSelfAttention::backpropagation(
...
///////////////////////////////////////////////////////////////
Layer *LayerSelfAttention::load(std::istream &from) { return NULL; }
///////////////////////////////////////////////////////////////
Layer *LayerSelfAttention::construct(std::initializer_list<float> fArgs,
                                     std::string sArg) {
  if (fArgs.size() != 0)
    return nullptr;
...
///////////////////////////////////////////////////////////////
bool LayerSelfAttention::has_weights() const { return false; }
///////////////////////////////////////////////////////////////////////////////
bool LayerSelfAttention::init(
