...
public:
  explicit LayerParallel(
      std::vector<Layer *> mParallelLayers,
      ParallelReduction mReduction); // todo: how to connect many outputs
...
protected:
  ...
  virtual std::string generate_mermaid_node() const override {
    ...
    case DOT:
      ...
      break;
    case ROWSTACK:
      reduction_name = "RowStack";
      break;
    case COLSTACK:
      reduction_name = "ColStack";
      break;
    default:
      reduction_name = "Unknown";
      break;
    }
