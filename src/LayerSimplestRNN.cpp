...
///////////////////////////////////////////////////////////////////////////////
void LayerSimplestRNN::forward_frame(const MatrixFloat &mInFrame,
                                     MatrixFloat &mOut) {
...
///////////////////////////////////////////////////////////////////////////////
void LayerSimplestRNN::backpropagation_frame(const MatrixFloat &mInFrame,
...
///////////////////////////////////////////////////////////////
// static
Layer *LayerSimplestRNN::load(std::istream &from) { return NULL; }
///////////////////////////////////////////////////////////////
// static
Layer *LayerSimplestRNN::construct(std::initializer_list<float> fArgs,
                                   std::string sArg) {
  if (fArgs.size() != 1)
...
///////////////////////////////////////////////////////////////
bool LayerSimplestRNN::has_weights() const { return false; }
///////////////////////////////////////////////////////////////
